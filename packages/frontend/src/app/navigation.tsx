...
const pageMetaRegistry: Array<{ pattern: string; meta: PageMeta }> = [
  ...
  },
  {
    ...
    meta: {
      ...
      breadcrumbs: [{ title: '应用可观测', path: '/observability/traces' }, { title: '调用明细' }],
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      section: 'evaluation',
      breadcrumbs: [{ title: '应用评测', path: '/eval/tasks' }, { title: '评测任务' }],
    },
  },
  {
  ...
  },
  {
    ...
    meta: {
      ...
      section: 'evaluation',
      breadcrumbs: [{ title: '应用评测', path: '/eval/tasks' }, { title: '评测集' }],
    },
  },
  {
    pattern: '/eval/datasets/create',
    meta: {
      title: '新建评测集',
      description: '创建新的评测数据集，支持多种数据源导入方式。',
      section: 'evaluation',
      breadcrumbs: [
        { title: '应用评测', path: '/eval/tasks' },
        { title: '评测集', path: '/eval/datasets' },
        { title: '新建评测集' },
      ],
    },
  },
  {
    pattern: '/eval/datasets/:id',
    meta: {
      title: '评测集详情',
      description: '查看评测集的数据项、标签和元信息。',
      section: 'evaluation',
      breadcrumbs: [
        { title: '应用评测', path: '/eval/tasks' },
        { title: '评测集', path: '/eval/datasets' },
  ...
  {
    pattern: '/eval/auto-eval/create',
    meta: {
      title: '创建自动化评测规则',
      description: '配置自动触发的评测链路，定义过滤采样规则和评估指标。',
      section: 'evaluation',
      breadcrumbs: [
        { title: '应用评测', path: '/eval/tasks' },
        { title: '自动化评测', path: '/eval/auto-eval' },
        { title: '创建规则' },
      ],
    },
  },
  {
    pattern: '/eval/prompts/:id',
    meta: {
      title: 'Prompt 详情',
      description: '查看 Prompt 的版本历史、内容对比和元数据。',
      section: 'evaluation',
      breadcrumbs: [
        { title: '应用评测', path: '/eval/tasks' },
        { title: 'Prompt 管理', path: '/eval/prompts' },
        { title: 'Prompt 详情' },
      ],
    },
  },
  {
    ...
    meta: {
      ...
      section: 'evaluation',
      breadcrumbs: [{ title: '应用评测', path: '/eval/tasks' }, { title: '评估指标' }],
    },
  },
  {
    ...
    meta: {
      ...
      section: 'evaluation',
      breadcrumbs: [{ title: '应用评测', path: '/eval/tasks' }, { title: '自动化评测' }],
    },
  },
  {
    ...
    meta: {
      ...
      section: 'evaluation',
      breadcrumbs: [{ title: '应用评测', path: '/eval/tasks' }, { title: 'Prompt 管理' }],
    },
  },
  {
    ...
    meta: {
      ...
      section: 'evaluation',
      breadcrumbs: [{ title: '应用评测', path: '/eval/tasks' }, { title: 'Playground' }],
    },
  },
  {
    ...
    meta: {
      ...
      section: 'evaluation',
      breadcrumbs: [{ title: '应用评测', path: '/eval/tasks' }, { title: 'Leaderboard' }],
    },
  },
  {
    pattern: '/eval/apps',
    meta: {
      ...
      section: 'evaluation',
      breadcrumbs: [{ title: '应用评测', path: '/eval/tasks' }, { title: 'AI 应用管理' }],
    },
  },
  {
    ...
    meta: {
      ...
      section: 'evaluation',
      breadcrumbs: [{ title: '应用评测', path: '/eval/tasks' }, { title: '设置' }],
    },
  },
];
