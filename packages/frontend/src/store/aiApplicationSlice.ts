...
const initialState: AIApplicationState = {
  applications: [],
  loading: false,
  error: null,
  total: 0,
...
export const fetchApplications = createAsyncThunk(
  'aiApplication/fetchApplications',
  async (params: QueryApplicationsParams, { rejectWithValue }) => {
    try {
...
export const fetchApplicationById = createAsyncThunk(
  'aiApplication/fetchApplicationById',
...
export const createApplication = createAsyncThunk(
  'aiApplication/createApplication',
...
export const updateApplication = createAsyncThunk(
  'aiApplication/updateApplication',
  async (
...
export const deleteApplication = createAsyncThunk(
  'aiApplication/deleteApplication',
  async (id: string, { rejectWithValue }) => {
    try {
...
export const importPublicAgent = createAsyncThunk(
  'aiApplication/importPublicAgent',
  async (data: ImportPublicAgentRequest, { rejectWithValue }) => {
    try {
...
export const { setPage, setPageSize, clearCurrentApplication, clearError } =
  aiApplicationSlice.actions;
